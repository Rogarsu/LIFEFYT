...
export function Step10_Summary({ onNext }: Props) {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      try {
        ...
        setRoutine(generateRoutine(weightMap))
      } catch (e) {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-dark-900 px-6">
        ...
        <div className="relative text-center">
          ...
          <h2 className="text-2xl font-black text-white mb-3">Analizando tu perfil...</h2>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-5 pb-32">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <p className="text-xs text-white/30 mb-1">Duración sesión</p>
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <p className="text-xs text-white/40 font-bold uppercase tracking-wider mb-3">Plan Semanal</p>
